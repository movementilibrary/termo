...
public class AceiteController {
    ...
    @ApiOperation(httpMethod = "POST", value = "Respons�vel por fazer o aceite do termo", response = AceiteTermoJson.class)
    ...
    public ResponseEntity buscarAceiteTermo(@RequestParam(required = false) String mdmId, @RequestParam(required = false) Long cip) {
