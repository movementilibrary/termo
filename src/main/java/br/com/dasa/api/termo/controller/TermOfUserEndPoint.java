...
public class TermOfUserEndPoint {
	...
	@GetMapping(value = "/term/user/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PostMapping(value = "/term/user/registry", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	public ResponseEntity<TermOfUser> findById(@RequestBody TermOfUser termOfUser) {
		try {
