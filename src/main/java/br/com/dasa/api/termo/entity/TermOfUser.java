...
public class TermOfUser {
	...
	public TermOfUser(Long id, String loginUser, String descriptionTerm, String summaryTerm, Date currentDate, String version, boolean flag, StatusTermUse status, boolean flagAtualizacao) {
		this.id = id;
